const { GetAdminSubscribePromotionsFull } = require('../../../../services').api.endpoints;
...
module.exports = app => {
  ...
  app.get(GetAdminSubscribePromotionsFull,
    [extractFilters, extractSorts],
    async (req, res) => {
      try {
        let data = await SubscribeSvc.Promotions.create().getAllFullInfo({
